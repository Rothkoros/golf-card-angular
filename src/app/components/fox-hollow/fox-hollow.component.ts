...
@Component({
  selector: 'app-fox-hollow',
  templateUrl: './fox-hollow.component.html',
  styleUrls: ['./fox-hollow.component.scss'],
  encapsulation: ViewEncapsulation.None,

})
export class FoxHollowComponent implements OnInit {

  constructor(private gameDetailService: GameDetailService,private router: Router, private http: HttpClient) {
