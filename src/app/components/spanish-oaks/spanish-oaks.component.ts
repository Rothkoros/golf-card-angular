...
@Component({
  selector: 'app-spanish-oaks',
  templateUrl: './spanish-oaks.component.html',
  styleUrls: ['./spanish-oaks.component.scss'],
})
export class SpanishOaksComponent implements OnInit {
  constructor(
